        ...
        <div className="relative grid gap-8 lg:grid-cols-[minmax(0,.92fr)_minmax(0,1.08fr)] lg:items-center lg:gap-10">
          <div className="max-w-[34rem]">
            ...
            <h2
              ...
              className="mt-4 font-display text-[2.1rem] font-semibold leading-[.98] tracking-[-0.045em] text-paper sm:text-[2.85rem]"
            >
              Complete Transparency.
              <span className="block text-[#F2A63C]">Every Lot.</span>
            </h2>
            <p className="mt-4 max-w-[31rem] text-[0.96rem] leading-6 text-[#C8CFDB] sm:text-[1rem]">
              Every lot is backed by third-party testing and organized documentation—because clarity is part of our standard.
            </p>

            <ul className="mt-6 grid gap-2.5" aria-label="Documentation standards">
          ...
          <div className="relative mx-auto flex w-full max-w-[500px] items-center justify-center lg:min-h-[340px]">
            ...
            <div className="relative overflow-hidden rounded-[4px] border border-[#DEE4EC] bg-white shadow-[0_26px_44px_-22px_rgba(0,0,0,.82)]">
              <Image
                src="/brand/aod-9604-coa.png"
                alt="AOD-9604 Certificate of Analysis from Bioviridian"
                width={538}
                height={632}
                priority
