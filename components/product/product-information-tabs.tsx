  ...
  return <div className="space-y-4">
    ...
    <div className="grid gap-5 lg:grid-cols-2 lg:gap-6">
      ...
      <section className="rounded-[9px] border border-[#E2E5EA] bg-paper p-5 sm:p-6" aria-labelledby="analytical-results-heading">
        ...
        {coa?.pdfUrl ? <a href={coa.pdfUrl} target="_blank" rel="noreferrer" download className="mt-5 flex min-h-14 items-center justify-center gap-4 rounded-[6px] border border-[#2D3452] px-5 text-sm font-semibold uppercase tracking-[.02em] text-[#2D3452] transition-colors hover:bg-[#F7F7F4]"><DownloadIcon className="h-6 w-6" />Download COA</a> : null}
      </section>
    </div>
  </div>;
}
...
function SnowflakeIcon({ className }: { className?: string }) { return <svg viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1.65" strokeLinecap="round" strokeLinejoin="round" className={className} aria-hidden="true"><path d="M12 2v20M4.2 6.5l15.6 11M4.2 17.5l15.6-11M8.7 3.9 12 2l3.3 1.9M8.7 20.1 12 22l3.3-1.9" /></svg>; }
