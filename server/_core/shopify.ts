...
const PRODUCT_FRAGMENT = /* GraphQL */ `
  ...
  fragment ProductFields on Product {
    ...
    lotNumber: metafield(namespace: "cellova_coa", key: "lot_number") { value }
    testedDate: metafield(namespace: "cellova_coa", key: "tested_date") { value }
    laboratory: metafield(namespace: "cellova_coa", key: "laboratory") { value }
    identityMs: metafield(namespace: "cellova_coa", key: "identity_ms") { value }
    purityHplc: metafield(namespace: "cellova_coa", key: "purity_hplc") { value }
    netContent: metafield(namespace: "cellova_coa", key: "net_content") { value }
    endotoxin: metafield(namespace: "cellova_coa", key: "endotoxin") { value }
