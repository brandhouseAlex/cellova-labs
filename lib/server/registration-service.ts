...
async function updateCustomer(customer: AdminCustomer, input: NormalizedRegistrationInput): Promise<AdminCustomer> {
  const result = await adminGraphql<{ customerUpdate: { customer: AdminCustomer | null; userErrors: Array<{ message?: string; field?: unknown }> } }>(
...
async function createCustomer(input: NormalizedRegistrationInput): Promise<AdminCustomer> {
  const result = await adminGraphql<{ customerCreate: { customer: AdminCustomer | null; userErrors: Array<{ message?: string; field?: unknown }> } }>(
...
async function createRegistrationMetaobject(schema: RegistrationSchema, input: NormalizedRegistrationInput): Promise<AdminRegistrationMetaobject> {
  const result = await adminGraphql<{ metaobjectCreate: { metaobject: AdminRegistrationMetaobject | null; userErrors: Array<{ message?: string; field?: unknown }> } }>(
...
async function updateRegistrationMetaobject(id: string, schema: RegistrationSchema, input: NormalizedRegistrationInput, complete: boolean): Promise<AdminRegistrationMetaobject> {
  const result = await adminGraphql<{ metaobjectUpdate: { metaobject: AdminRegistrationMetaobject | null; userErrors: Array<{ message?: string; field?: unknown }> } }>(
...
async function attachRegistrationReference(customerId: string, registrationId: string): Promise<void> {
  const result = await adminGraphql<{ metafieldsSet: { userErrors: Array<{ message?: string; field?: unknown }> } }>(
